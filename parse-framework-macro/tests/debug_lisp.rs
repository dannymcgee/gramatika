...
///
/// ```
/// impl<'a> ::parse_framework::DebugLisp for Token<'a> {
...
/// }
///
/// impl<'a> ::parse_framework::DebugLisp for Expr<'a> {
...
///             Expr::Binary(inner) => {
///                 write!(f, "{}(", "BinaryExpr")?;
///                 <BinaryExpr<'a> as ::parse_framework::DebugLisp>::fmt(&inner, f, indent)
///             }
///             Expr::Unary(inner) => {
///                 write!(f, "{}(", "UnaryExpr")?;
///                 <UnaryExpr<'a> as ::parse_framework::DebugLisp>::fmt(&inner, f, indent)
///             }
///             Expr::Primary(inner) => {
///                 write!(f, "{}(", "PrimaryExpr")?;
///                 <PrimaryExpr<'a> as ::parse_framework::DebugLisp>::fmt(&inner, f, indent)
///             }
///         }?;
///
///         write!(f, ")")
...
/// }
///
/// impl<'a> ::parse_framework::DebugLisp for BinaryExpr<'a> {
///     fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>, indent: usize) -> ::std::fmt::Result {
///         ::parse_framework::DebugLispStruct::new(f, indent, "BinaryExpr")
///             .field("lhs", &self.lhs)
///             .field("op", &self.op)
///             .field("rhs", &self.rhs)
///             .finish()
...
/// }
///
/// impl<'a> ::parse_framework::DebugLisp for UnaryExpr<'a> {
///     fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>, indent: usize) -> ::std::fmt::Result {
///         ::parse_framework::DebugLispStruct::new(f, indent, "UnaryExpr")
///             .field("op", &self.op)
///             .field("rhs", &self.rhs)
///             .finish()
///     }
/// }
///
/// impl<'a> ::parse_framework::DebugLisp for PrimaryExpr<'a> {
///     fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>, indent: usize) -> ::std::fmt::Result {
///         ::parse_framework::DebugLispStruct::new(f, indent, "PrimaryExpr")
...
///         write!(f, "{}: ", "Program")?;
///         ::parse_framework::DebugLisp::fmt(&self.exprs, f, 0)
///     }
/// }
/// ```
